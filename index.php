...
<!-- Mirrored from motaadmin.dexignlab.com/xhtml/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Aug 2021 12:07:26 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width,initial-scale=1">
    <title>Administration | Tech-innosoft </title>
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="vues/templates/images/favicon.png">
    <link href="vues/templates/vendor/jqvmap/css/jqvmap.min.css" rel="stylesheet">
	<link rel="stylesheet" href="vues/templates/vendor/chartist/css/chartist.min.css">
    <link href="vues/templates/vendor/bootstrap-select/dist/css/bootstrap-select.min.css" rel="stylesheet">
    <link href="vues/templates/css/style.css" rel="stylesheet">
	<link href="vues/templates/cdn.lineicons.com/2.0/LineIcons.css" rel="stylesheet">
...
<body>
    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
                <img class="logo-abbr" src="vues/templates/images/logo-white.png" alt="">
                <img class="logo-compact" src="vues/templates/images/logo-text.png" alt="">
                <img class="brand-title" src="vues/templates/images/logo-text.png" alt="">
            </a>
								...
								<ul class="contacts">
									...
									<li class="active dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="vues/templates/images/avatar/1.jpg" class="rounded-circle user_img" alt=""/>
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="vues/templates/images/avatar/2.jpg" class="rounded-circle user_img" alt=""/>
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="vues/templates/images/avatar/3.jpg" class="rounded-circle user_img" alt=""/>
												<span class="online_icon"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="vues/templates/images/avatar/4.jpg" class="rounded-circle user_img" alt=""/>
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="vues/templates/images/avatar/5.jpg" class="rounded-circle user_img" alt=""/>
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
							...
							<div class="card-body msg_card_body dz-scroll" id="DZ_W_Contacts_Body3">
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
										<img src="vues/templates/images/avatar/1.jpg" class="rounded-circle user_img_msg" alt=""/>
									</div>
								...
								<div class="d-flex justify-content-end mb-4">
									...
									<div class="img_cont_msg">
								<img src="vues/templates/images/avatar/2.jpg" class="rounded-circle user_img_msg" alt=""/>
									</div>
								</div>
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
                        ...
                        <ul class="navbar-nav header-right">
											...
											<li>
												<div class="timeline-panel">
													<div class="media mr-2">
														<img alt="image" width="50" src="vues/templates/images/avatar/1.jpg">
													</div>
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                                    <img src="vues/templates/images/profile/pic1.jpg" width="20" alt=""/>
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by <a href="http://dexignlab.com/" target="_blank">Ir Joseph </a> 2021</p>
            </div>
        </div>
        <!--**********************************
            Footer end
    ...
    ***********************************-->
    <!-- Required vendors -->
    <script src="vues/templates/vendor/global/global.min.js"></script>
	<script src="vues/templates/vendor/bootstrap-select/dist/js/bootstrap-select.min.js"></script>
    <script src="vues/templates/vendor/chart.js/Chart.bundle.min.js"></script>
    <script src="vues/templates/js/custom.min.js"></script>
	<script src="vues/templates/js/deznav-init.js"></script>
	<!-- Apex Chart -->
	<script src="vues/templates/vendor/apexchart/apexchart.js"></script>
	
    <!-- Vectormap -->
	<!-- Chart piety plugin files -->
    <script src="vues/templates/vendor/peity/jquery.peity.min.js"></script>
	
    <!-- Chartist -->
    <script src="vues/templates/vendor/chartist/js/chartist.min.js"></script>
	
	<!-- Dashboard 1 -->
	<script src="vues/templates/js/dashboard/dashboard-1.js"></script>
	<!-- Svganimation scripts -->
	<script src="vues/templates/vendor/svganimation/vivus.min.js"></script>
    <script src="vues/templates/vendor/svganimation/svg.animation.js"></script>
	
</body>

<!-- Mirrored from motaadmin.dexignlab.com/xhtml/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Aug 2021 12:10:43 GMT -->
</html>